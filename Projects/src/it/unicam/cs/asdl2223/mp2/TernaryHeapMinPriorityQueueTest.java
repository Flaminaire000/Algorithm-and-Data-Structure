...
class TernaryHeapMinPriorityQueueTest {
    ...
    final void testExtractMinimum() {
        ...
        assertTrue(min == j15);
        System.out.println(a.get(0)== j21);
    ...
    final void testDecreasePriority() {
        ...
        for(int i=0; i<14; i++)
        {
        	System.out.println(h.getTernaryHeap().get(i).getPriority());
        	System.out.print(h.getTernaryHeap().get(i).getHandle());
        	System.out.print(" ");
        }
        ...
        for(int i=0; i<14; i++)
        {   System.out.print("/");
        	System.out.print(h.getTernaryHeap().get(i).getPriority());
        	System.out.print(h.getTernaryHeap().get(i).getHandle());
        	System.out.println(" ");
        }
        assertTrue(j30.getPriority()== 14);
        //System.out.println(j30.getHandle());
